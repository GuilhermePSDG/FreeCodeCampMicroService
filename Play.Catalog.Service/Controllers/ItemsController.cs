...
namespace Play.Catalog.Service.Controllers
{
    ...
    public class ItemsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAll() => Ok((await this.repo.GetAllAsync()).Select(x => x.AsDto()));
        ...
        public async Task<IActionResult> PostItem(CreateItemDto createItemDto)
        {
            ...
            await this.repo.CreateAsync(item);
        ...
        public async Task<IActionResult> Put([FromRoute]Guid Id,[FromBody]UpdateItemDto updateItemDto)
        {
            ...
            item = await this.repo.UpdateAsync(item);
            return item == null? BadRequest() : Ok(item);
        }
        [HttpDelete("{Id}")]
        public async Task<IActionResult> Delete([FromRoute] Guid Id)
        {
            return await this.repo.DeleteAsync(Id) ? Ok() : BadRequest();
        }
